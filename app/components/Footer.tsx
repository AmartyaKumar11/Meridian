          ...
          <div className="col-span-2 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-3 text-[#7C7E8C] dark:text-gray-400">
                ...
                <a href="https://www.instagram.com/amartyakumar11/" target="_blank" rel="noopener noreferrer" className="hover:text-[#44475B] dark:hover:text-gray-200">
                ...
                <a href="https://www.linkedin.com/in/amartya-kumar-561669282/" target="_blank" rel="noopener noreferrer" className="hover:text-[#44475B] dark:hover:text-gray-200">
