          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button className="text-xs text-[#00D09C] hover:text-[#00B386]">All Indices</button>
              </div>
              ...
              <div className="relative">
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-[#1A1D24] rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 py-2">
                    ...
                    <div className="py-1">
                      <a href="#" className="block px-4 py-2 text-xs text-[#44475B] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#1F2228]">Dashboard</a>
                      <a href="#" className="block px-4 py-2 text-xs text-[#44475B] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#1F2228]">Settings</a>
                    </div>
