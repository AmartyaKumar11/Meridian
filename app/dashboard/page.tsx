...
export default function Dashboard() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#0C0E12] transition-colors duration-300">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-6 text-xs">
                <a href="/dashboard" className="text-black dark:text-white font-medium">Stocks</a>
                <a href="/fo" className="text-[#7C7E8C] dark:text-gray-400 hover:text-black dark:hover:text-white">F&O</a>
                <a href="/mutual-funds" className="text-[#7C7E8C] dark:text-gray-400 hover:text-black dark:hover:text-white">Mutual Funds</a>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Bell className="w-4 h-4 text-gray-600 dark:text-gray-400 cursor-pointer" />
              ...
              <div className="relative">
                ...
                {isProfileOpen && (
                  <>
                    ...
                    ></div>
                    <div className="absolute right-0 top-10 w-72 bg-white dark:bg-[#1A1D24] rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 z-50">
                      <div className="p-4 border-b border-gray-200 dark:border-gray-800">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <p className="text-sm font-medium text-[#44475B] dark:text-gray-200">Amartya Kumar</p>
                            <p className="text-xs text-[#7C7E8C] dark:text-gray-400">kumaramartya11@gmail.com</p>
                          </div>
                          <button className="text-[#7C7E8C] dark:text-gray-400 hover:text-[#44475B] dark:hover:text-gray-200">
                        ...
                        <div className="bg-[#F8F9FA] dark:bg-[#0F1115] rounded-lg p-2 mt-2">
                          <p className="text-xs text-[#7C7E8C] dark:text-gray-400 mb-1">Balance</p>
                          <p className="text-sm font-medium text-[#44475B] dark:text-gray-200">₹0.00 <span className="text-xs text-[#7C7E8C] dark:text-gray-400">Stocks, F&O balance</span></p>
                        </div>
                      </div>
                      
                      <div className="py-1">
                        <button className="w-full px-4 py-2.5 text-left text-sm text-[#44475B] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1F2228] flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <CreditCard className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" />
                            <span>All Orders</span>
                          </div>
                          <svg className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                        </button>
                        <button className="w-full px-4 py-2.5 text-left text-sm text-[#44475B] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1F2228] flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <FileBarChart className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" />
                        ...
                        <button className="w-full px-4 py-2.5 text-left text-sm text-[#44475B] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1F2228] flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <Headphones className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" />
                        ...
                        <button className="w-full px-4 py-2.5 text-left text-sm text-[#44475B] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1F2228] flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <FileText className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" />
                            <span>Reports</span>
                          </div>
                          <svg className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      ...
                      <div className="border-t border-gray-200 dark:border-gray-800 p-3 flex items-center justify-between">
                        <button 
                          onClick={toggleTheme}
                          className="p-1.5 hover:bg-gray-100 dark:hover:bg-[#1F2228] rounded"
                        >
                          {theme === "light" ? (
                            <Moon className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" />
                          ) : (
                            <Sun className="w-4 h-4 text-[#7C7E8C] dark:text-gray-400" />
                          )}
                        </button>
                        <button 
                          onClick={handleLogout}
                          className="text-sm text-[#44475B] dark:text-gray-300 hover:underline flex items-center gap-2"
                        >
      ...
      <div className="bg-white/80 dark:bg-[#1A1D24]/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 sticky top-[52px] z-40 transition-colors duration-300">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="flex items-center space-x-8 text-xs">
            ...
            <button className="py-2.5 text-[#7C7E8C] dark:text-gray-400 hover:text-[#44475B] dark:hover:text-white">Holdings</button>
            <button className="py-2.5 text-[#7C7E8C] dark:text-gray-400 hover:text-[#44475B] dark:hover:text-white">Positions</button>
            <button className="py-2.5 text-[#7C7E8C] dark:text-gray-400 hover:text-[#44475B] dark:hover:text-white">Orders</button>
            <button className="py-2.5 text-[#7C7E8C] dark:text-gray-400 hover:text-[#44475B] dark:hover:text-white">Watchlist</button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-6">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-8 space-y-6">
            ...
            {/* Top Market Movers */}
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Top market movers</h2>
              <div className="flex items-center space-x-3 mb-4">
                <button className="px-3 py-1.5 bg-gray-100 dark:bg-[#1F2228] rounded-full text-xs font-medium text-[#44475B] dark:text-gray-200">Gainers</button>
                <button className="px-3 py-1.5 text-xs text-[#7C7E8C] dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-[#1F2228] rounded-full">Losers</button>
                <button className="px-3 py-1.5 text-xs text-[#7C7E8C] dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-[#1F2228] rounded-full">Volume shockers</button>
                <button className="px-3 py-1.5 text-xs text-[#7C7E8C] dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-[#1F2228] rounded-full border border-gray-300 dark:border-gray-700">NIFTY 100 ▼</button>
              </div>
              <div className="space-y-1">
                <div className="grid grid-cols-12 gap-4 text-xs text-[#7C7E8C] dark:text-gray-400 pb-2 border-b dark:border-gray-800">
            ...
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Most traded stocks in MTF</h2>
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <div key={idx} className="border border-gray-200 dark:border-gray-800 rounded-lg p-3 hover:shadow-md transition-shadow cursor-pointer">
                    <div className="w-10 h-10 bg-gray-100 dark:bg-[#0F1115] rounded-lg flex items-center justify-center mb-2">
                      <span className="text-xs font-semibold text-[#44475B] dark:text-gray-300">{stock.name.slice(0, 2).toUpperCase()}</span>
                    </div>
                    <div className="text-xs font-medium text-[#44475B] dark:text-gray-300 mb-1">{stock.name}</div>
                    <div className="text-base font-semibold text-[#44475B] dark:text-gray-200 mb-0.5">₹{stock.price}</div>
                    <div className={`text-xs ${stock.isNegative ? 'text-red-600' : 'text-green-600'}`}>
            ...
            {/* Top Intraday Stocks */}
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Top intraday stocks</h2>
              <div className="grid grid-cols-4 gap-3">
                {[
                  { name: "Adani Power", price: "162.10", change: "-0.23 (0.14%)", isNegative: true },
            ...
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Sectors trending today</h2>
              <div className="space-y-4">
                ...
                {[
                  ...
                  return (
                    <div key={idx} className="grid grid-cols-12 gap-4 items-center py-2 hover:bg-gray-50 dark:hover:bg-[#1F2228] cursor-pointer">
                      <div className="col-span-3 flex items-center space-x-2">
                        <div className={`w-8 h-8 bg-gray-100 dark:bg-[#0F1115] rounded-full flex items-center justify-center ${sector.color}`}>
                          <IconComponent className="w-4 h-4" />
                        </div>
                        <span className="text-xs text-[#44475B] dark:text-gray-300">{sector.name}</span>
                      </div>
                      <div className="col-span-6">
                        <div className="flex items-center space-x-2">
                          <span className="text-xs text-[#44475B] dark:text-gray-300">{sector.gainers}</span>
                          <div className="flex-1 h-1.5 bg-gray-100 dark:bg-[#0F1115] rounded-full overflow-hidden flex">
                            <div 
                          ...
                          <span className="text-xs text-[#44475B] dark:text-gray-300">{sector.losers}</span>
                        </div>
                      </div>
            ...
            {/* ETFs by Groww */}
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">ETFs by Meridian</h2>
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <div key={idx} className="border border-gray-200 dark:border-gray-800 rounded-lg p-3 hover:shadow-md transition-shadow cursor-pointer">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#00D09C] to-[#00B386] rounded-full flex items-center justify-center mb-2">
                      <div className="w-6 h-6 bg-white dark:bg-gray-200 rounded-full"></div>
                    </div>
                    <div className="text-xs font-medium text-[#44475B] dark:text-gray-300 mb-2">{etf.name}</div>
                    {etf.status ? (
                      <>
                        <div className="text-xs text-[#7C7E8C] dark:text-gray-400 mb-1">{etf.status}</div>
                        <div className={`text-xs ${etf.isOpen ? 'text-[#00B386]' : 'text-[#7C7E8C] dark:text-gray-400'}`}>
                          {etf.statusText}
                        </div>
                      </>
                    ) : (
                      <>
                        <div className="text-base font-semibold text-[#44475B] dark:text-gray-200 mb-0.5">₹{etf.price}</div>
            ...
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Stocks in news today</h2>
                ...
                {[
                  ...
                  <div key={idx} className="border border-gray-200 dark:border-gray-800 rounded-lg p-3 hover:shadow-md transition-shadow cursor-pointer">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center space-x-2">
                        <div className="w-10 h-10 bg-gray-100 dark:bg-[#0F1115] rounded-lg flex items-center justify-center">
                          <span className="text-xs font-bold text-[#44475B] dark:text-gray-300">{stock.logo}</span>
                        </div>
                        <div>
                          <div className="text-xs font-medium text-[#44475B] dark:text-gray-300">{stock.name}</div>
                          <div className={`text-xs ${stock.isNegative ? 'text-red-600' : 'text-green-600'}`}>
                            {stock.change}
                          </div>
                        </div>
          ...
          <div className="col-span-4 space-y-6 sticky top-[135px] self-start">
            {/* Your Investments */}
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Your investments</h2>
              <div className="flex flex-col items-center justify-center py-6">
                <div className="w-24 h-24 bg-gradient-to-br from-blue-50 to-green-50 dark:from-blue-950 dark:to-green-950 rounded-full mb-3 flex items-center justify-center">
                  <BarChart3 className="w-10 h-10 text-[#00B386]" />
                </div>
                <p className="text-xs text-[#7C7E8C] dark:text-gray-400 text-center">You haven't invested yet</p>
              </div>
            </div>

            {/* Products & Tools */}
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Products & Tools</h2>
              <div className="space-y-2">
                {[
                  ...
                  return (
                    <div key={idx} className="flex items-center justify-between py-2 hover:bg-gray-50 dark:hover:bg-[#1F2228] cursor-pointer rounded-lg px-2">
                      <div className="flex items-center space-x-3">
                        <div className={`w-8 h-8 rounded-lg bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center ${item.color}`}>
                          <IconComponent className="w-4 h-4" />
                        </div>
                        <span className="text-xs text-[#44475B] dark:text-gray-300">{item.name}</span>
                      </div>
                      {item.status && (
            ...
            {/* Trading Screens */}
            <div className="bg-white dark:bg-[#1A1D24] rounded-lg p-5 transition-colors duration-300">
              <h2 className="text-lg font-semibold text-[#44475B] dark:text-gray-200 mb-4">Trading Screens</h2>
              <div className="space-y-2">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between py-2 hover:bg-gray-50 dark:hover:bg-[#1F2228] cursor-pointer rounded-lg px-2">
                    <div>
                      ...
                      <div className="text-xs text-[#44475B] dark:text-gray-300">{screen.name}</div>
                    </div>
                    <div className="w-14 h-10 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded flex items-center justify-center">
                      {screen.color === 'green' ? (
      ...
      {/* Footer */}
      <footer className="bg-white dark:bg-[#1A1D24] border-t border-gray-200 dark:border-gray-800 mt-12 transition-colors duration-300">
        <div className="max-w-[1400px] mx-auto px-6 py-8">
          <div className="grid grid-cols-12 gap-8 mb-8">
            ...
            <div className="col-span-3">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-lg font-semibold text-[#44475B] dark:text-gray-200">Meridian</span>
              </div>
              <div className="text-xs text-[#7C7E8C] dark:text-gray-400 mb-4 leading-relaxed">
            ...
            <div className="col-span-2">
              <h3 className="text-xs font-semibold text-[#44475B] dark:text-gray-200 mb-3">Download the App</h3>
              <div className="flex space-x-2">
                <a href="#" className="hover:opacity-80 text-[#44475B] dark:text-gray-300">
            ...
            {/* GROWW */}
            <div className="col-span-2">
              <h3 className="text-xs font-semibold text-[#44475B] dark:text-gray-200 mb-3">MERIDIAN</h3>
              <div className="space-y-2">
            ...
            {/* PRODUCTS */}
            <div className="col-span-2">
              <h3 className="text-xs font-semibold text-[#44475B] dark:text-gray-200 mb-3">PRODUCTS</h3>
          ...
          <div className="border-t border-gray-200 dark:border-gray-800 pt-6">
            <div className="flex items-center space-x-6 text-xs text-[#44475B] dark:text-gray-300 mb-6">
              ...
              <button className="text-[#7C7E8C] dark:text-gray-400 hover:text-[#44475B] dark:hover:text-gray-200">Funds By Groww</button>
